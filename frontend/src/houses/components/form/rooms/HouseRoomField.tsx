...
export const HouseRoomField: React.FC<HouseRoomFieldProps> = (props: HouseRoomFieldProps) => {
  ...
  return (
    <Box display="flex" flexDirection="column">
      <FormControl error>
        <TextField label={t('house:form.room.type')} value={roomEntity?.type} onChange={handleChangeField('type')} required />
      </FormControl>
      <FormControl error>
        <TextField
          type="number"
      ...
      <FormControl error>
        <TextField type="number" label={t('house:form.room.windows')} onChange={handleChangeField('windows')} value={roomEntity?.windows} required />
      </FormControl>
      <FormControl error>
        <TextField type="number" label={t('house:form.room.windowDoors')} onChange={handleChangeField('windowsDoors')} value={roomEntity?.surface} />
      </FormControl>
